...
setup_teleport_aftereffects()
{
	...
	{
		level.teleport_ae_funcs[level.teleport_ae_funcs.size] = clientscripts\dlc3_teleporter::teleport_aftereffect_fov;
	}
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = clientscripts\dlc3_teleporter::teleport_aftereffect_shellshock;
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = clientscripts\dlc3_teleporter::teleport_aftereffect_shellshock_electric;
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = clientscripts\dlc3_teleporter::teleport_aftereffect_bw_vision;
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = clientscripts\dlc3_teleporter::teleport_aftereffect_red_vision;
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = clientscripts\dlc3_teleporter::teleport_aftereffect_flashy_vision;
	level.teleport_ae_funcs[level.teleport_ae_funcs.size] = clientscripts\dlc3_teleporter::teleport_aftereffect_flare_vision;
}
