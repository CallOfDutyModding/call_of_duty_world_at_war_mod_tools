...
mainframe_link_all = getEnt( 0, "mainframe_link_all", "targetname" );
if( isDefined( mainframe_link_all ) )
{
     	ent = clientscripts\_fx::createExploder( "zombie_mainframe_link_all" );
...
mainframe_links = getEntArray( 0, "fx_mainframe_link", "targetname" );
...
pads = getEntArray( 0, "fx_elec_pads", "targetname" );
if( isDefined( pads[ 0 ] ) )
{
			for( x = 0 ; x < pads.size; x++ )
 			{
     	ent = clientscripts\_fx::createExploder( "transporter_beam" );
...
mainframe_linked = getEnt( 0, "fx_mainframe_linked", "targetname" );
if( isDefined( mainframe_linked ) )
{
     	ent = clientscripts\_fx::createExploder( "zombie_mainframe_linked" );
...
beam = getEnt( 0, "fx_mainframe_beam", "targetname" );
if( isDefined( beam ) )
{
     	ent = clientscripts\_fx::createExploder( "zombie_mainframe_beam" );
     	...
     	ent = clientscripts\_fx::createExploder( 	"zombie_mainframe_beam_start" );
     	ent.v[ "origin" ] = ( beam.origin );
     	ent.v[ "angles" ] = ( 270, 0, 0 );
     	...
     	ent = clientscripts\_fx::createExploder( "zombie_mainframe_flat" );
     	ent.v[ "origin" ] = ( beam.origin );
     	ent.v[ "angles" ] = ( 270, 180, 180 );
     	...
     	ent = clientscripts\_fx::createExploder( "zombie_mainframe_flat_start" );
     	ent.v[ "origin" ] = ( beam.origin );
     	ent.v[ "angles" ] = ( 270, 0, 0 );
...
room = getEnt( 0, "teleport_room_0", "targetname" );
if( isDefined( room ) )
{
     	ent = clientscripts\_fx::createExploder( "zombie_flashback_american" );
...
room = getEnt( 0, "teleport_room_1", "targetname" );
if( isDefined( room ) )
{
     	ent = clientscripts\_fx::createExploder( "zombie_flashback_american" );
     	ent.v[ "origin" ] = ( room.angles[0] - 0.08, room.angles[1] + 40.023, room.angles[2] + 59.73 );
...
room = getEnt( 0, "teleport_room_2", "targetname" );
if( isDefined( room ) )
{
     	ent = clientscripts\_fx::createExploder( "zombie_flashback_american" );
     	ent.v[ "origin" ] = ( room.angles[0] - 0.08, room.angles[1] + 40.023, room.angles[2] + 59.73 );
...
room = getEnt( 0, "teleport_room_3", "targetname" );
if( isDefined( room ) )
{
     	ent = clientscripts\_fx::createExploder( "zombie_flashback_american" );
     	ent.v[ "origin" ] = ( room.angles[0] - 0.08, room.angles[1] + 40.023, room.angles[2] + 59.73 );
 ...
 trans_start = getEntArray( 0, "fx_trans_start", "targetname" );
 if( isDefined( trans_start[ 0 ] ) )
 {
 			for( x = 0 ; x < trans_start.size; x++ )
 			{ 
     	ent = clientscripts\_fx::createExploder( "transporter_start" );
 ...
 zombie_dif_spots = getEntArray( 0, "fx_tele_gen", "targetname" );
 if( isDefined( zombie_dif_spots[ 0 ] ) )
 {
 			for( x = 0 ; x < zombie_dif_spots.size; x++ )
 			{
     	ent = clientscripts\_fx::createExploder( "zombie_difference" );
 ...
 steam_spots = getEntArray( 0, "fx_mainframe_steam", "targetname" );
 if( isDefined( steam_spots[ 0 ] ) )
 {
 			for( x = 0 ; x < steam_spots.size; x++ )
 			{
     	ent = clientscripts\_fx::createExploder( "zombie_mainframe_steam" );
 ...
 heatSinks = getEntArray( 0, "fx_heatsink", "targetname" );
 if( isDefined( heatSinks[ 0 ] ) )
 {
 			for( x = 0 ; x < heatSinks.size; x++ )
 			{
     	ent = clientscripts\_fx::createExploder( "zombie_heat_sink" );
...
trans_amb = getEntArray( 0, "fx_trans_amb", "targetname" );
if( isDefined( trans_amb[ 0 ] ) )
{
			for( x = 0 ; x < trans_amb.size; x++ )
 			{
     	ent = clientscripts\_fx::createExploder( "transporter_ambient" );
...
elec_gen_spots = getEntArray( 0, "elec_gen_idle", "targetname" );
if( isDefined( elec_gen_spots[ 0 ] ) )
{
 			for( x = 0 ; x < elec_gen_spots.size; x++ )
 			{
     	ent = clientscripts\_fx::createExploder( "zombie_elec_gen_idle" );
...
light_spots = getEntArray( 0, "fx_light_spot", "targetname" );
if( isDefined( light_spots[ 0 ] ) )
{
 			for( x = 0 ; x < light_spots.size; x++ )
 			{
     	ent = clientscripts\_fx::createExploder( "mp_light_lamp_no_eo" );
